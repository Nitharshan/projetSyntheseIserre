...
#define XB_API_MODE									2

// SENSOR AND ACTUATOR TYPE DEFINITIONS

#define Sensor_Temperature_Type						0x85
#define Sensor_Humindity_Type						0x86
#define Sensor_CO2_Type								0x87
#define Sensor_SoilMoisture_Type					0x89
#define Actuator_Van_Type							0x8F
#define Actuator_Humidificateur_Type				0x9A
#define Actuator_Hotplate_Type						0x9B
